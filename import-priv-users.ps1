...
#$userlist.samaccountname | Foreach-object {$_ + "@dolmain.com"} | Out-File ~\priv-users.txt

### Make sure to provide permision to the script running user to "C:\Program Files\LogRhythm"
